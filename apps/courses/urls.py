...
urlpatterns = [
    ...
    path('dashboard/courses/<slug:course_slug>/sections/<int:section_id>/lessons/reorder/', views.reorder_lessons, name='reorder_lessons'),
    path('dashboard/courses/<slug:course_slug>/sections/<int:section_id>/subsections/<int:subsection_id>/lessons/reorder/', views.reorder_subsection_lessons, name='reorder_subsection_lessons'),
    ...
    path('dashboard/courses/check-title/', views.check_course_title, name='check_course_title'),
    ...
    path('dashboard/courses/<slug:course_slug>/sections/<int:section_id>/subsections/create/', views.create_subsection, name='create_subsection'),
    path('dashboard/courses/<slug:course_slug>/sections/<int:section_id>/subsections/<int:subsection_id>/edit/', views.edit_subsection, name='edit_subsection'),
    path('dashboard/courses/<slug:course_slug>/sections/<int:section_id>/subsections/<int:subsection_id>/delete/', views.delete_subsection, name='delete_subsection'),
    path('dashboard/courses/<slug:course_slug>/sections/<int:section_id>/subsections/reorder/', views.reorder_subsections, name='reorder_subsections'),
